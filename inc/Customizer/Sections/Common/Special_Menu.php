<?php
/**
 * Special_Menu class file for customizer
 *
 * @package restaurant
 */
...
class Special_Menu extends Common {
    protected $section     = 'common_special_menu_section';
    protected $option_name = 'common_special_menu_section';
