...
class Enqueue {
    ...
    public function register_style() {
        ...
        wp_enqueue_style( 'fontawesome-all', THEME_URI . '/assets/vendor/fontawesome/css/all.min.css', [], THEME_VERSION );
    ...
    public function register_script() {
        ...
        wp_enqueue_script( 'popper', THEME_URI . '/assets/vendor/bootstrap/popper.min.js', ['jquery'], THEME_VERSION, true );
